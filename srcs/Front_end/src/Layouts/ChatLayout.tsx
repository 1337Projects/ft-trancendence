        ...
        <>
            <div className={`${theme === 'light' ? "text-lightText" : "text-darkText"} w-full h-[94vh] overflow-scroll mt-2 shadow-sm rounded-sm flex-grow`}>
                <div className="flex w-full min-h-[600px] h-full">
                    <div className={`h-full ${theme == 'light' ? "bg-white border-black/20" : "bg-darkItems border-white/30"} border-r-[.3px] rounded-sm z-10 w-[90px] xl:w-[300px]  ${menu ? "active-menu absolute" : "non-active-menu"}`}>
