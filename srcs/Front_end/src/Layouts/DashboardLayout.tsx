...
function LogoImg() {
  ...
  return (
    <svg className='max-w-full max-h-full' width="202" height="184" viewBox="0 0 202 184" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M55.9512 1.77454L206.268 22.0506" stroke={color1} stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M55.9512 28.3816L206.268 34.7125" stroke={color1} stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M55.9512 54.9885L206.268 47.2887" stroke={color1} stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M55.9512 81.5101L206.268 59.9507" stroke={color1} stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M55.9512 108.117L206.268 72.5269" stroke={color1} stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M136.542 89.0387V12.6398" stroke={color1} stroke-width="2" stroke-miterlimit="10"/>
      <path d="M97 97L96 8" stroke={color1} stroke-width="2" stroke-miterlimit="10"/>
      <path d="M56.0175 108L56 2" stroke={color1} stroke-width="2" stroke-miterlimit="10"/>
      <path d="M169.052 81.339V17.0031" stroke={color1} stroke-width="2" stroke-miterlimit="10"/>
      <path d="M193.691 74.2379V20.3395" stroke={color1} stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
      ...
      <path d="M19.6005 92.933C28.5705 83.9676 46.1608 78.686 63.9062 93.9608C81.0471 108.701 81.6063 113.745 75.4273 130.593C73.761 135.155 75.8781 141.363 79.068 144.531C89.8609 155.335 97.2087 160.285 99.9337 162.956C102.64 165.696 97.8176 171.023 97.8176 171.023C97.8176 171.023 92.5301 175.852 89.7796 173.137C87.0988 170.441 82.1447 163.103 71.3263 152.255C68.1363 149.087 61.925 147.018 57.3361 148.67C40.5805 154.885 35.4921 154.348 20.7007 137.246C5.41179 119.488 10.656 101.943 19.6005 92.933Z" stroke={color1} stroke-width="2" stroke-miterlimit="10"/>
      <path d="M36.0117 150.862L77.5795 109.232" stroke={color1} stroke-width="2" stroke-miterlimit="10"/>
