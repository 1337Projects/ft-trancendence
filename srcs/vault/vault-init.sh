...
store_secret_if_not_exists secret/data/settings DB_NAME="ft_transcendence" DB_OWNER="ipman" PASSWORD="133742" HOST="database" PORT="5432" EMAIL_BACKEND='django.core.mail.backends.smtp.EmailBackend' EMAIL_HOST='smtp.gmail.com' EMAIL_PORT=587 EMAIL_USE_TLS=true EMAIL_HOST_USER='benhammoukhawla99@gmail.com' EMAIL_HOST_PASSWORD='uqii arug mngk vbzk' API_URL="https://localhost:1024/"
